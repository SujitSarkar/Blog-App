...
class _ProfileState extends State<Profile> {
  ...
  void initState() {
    ...
    profileViewModel.fetchUserProfileData();
    super.initState();
  }
        ...
        builder: (context, state) {
          if(state is VelocityInitialState){
            ...
            return ListRefreshIndicator(
              onRefresh: () async => await profileViewModel.fetchUserProfileData(),
              child: ListView(
              children: [
                Container(
                  ...
                  child: Column(
                    children: [
                      CircleAvatar(
                        backgroundImage:
                             NetworkImage(state.data.userDetails!.profilePhotoUrl!),
                        radius: 64.r,
                      ),
                      12.h.heightBox,
                ...
                GridView.builder(
                  ...
                  itemBuilder: (context, index) => MyPostGridTile(myPost: state.data.posts![index]),
                )
              ],
                        ),
            );
